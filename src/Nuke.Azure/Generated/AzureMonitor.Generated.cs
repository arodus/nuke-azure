...
namespace Nuke.Azure
{
    ...
    public static partial class AzureMonitorTasks
    {
        ...
        public static IEnumerable<string> AzureMonitor(string arguments, string workingDirectory = null, ProcessSettings processSettings = null)
        {
            var process = ProcessTasks.StartProcess(AzureMonitorPath, arguments, workingDirectory, processSettings?.EnvironmentVariables, processSettings?.ExecutionTimeout, processSettings?.RedirectOutput ?? true);
