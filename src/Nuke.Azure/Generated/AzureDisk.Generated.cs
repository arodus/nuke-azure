...
namespace Nuke.Azure
{
    ...
    public static partial class AzureDiskTasks
    {
        ...
        public static IEnumerable<string> AzureDisk(string arguments, string workingDirectory = null, ProcessSettings processSettings = null)
        {
            var process = ProcessTasks.StartProcess(AzureDiskPath, arguments, workingDirectory, processSettings?.EnvironmentVariables, processSettings?.ExecutionTimeout, processSettings?.RedirectOutput ?? true);
