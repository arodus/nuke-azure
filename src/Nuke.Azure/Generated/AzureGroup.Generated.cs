...
namespace Nuke.Azure
{
    ...
    public static partial class AzureGroupTasks
    {
        ...
        public static IEnumerable<string> AzureGroup(string arguments, string workingDirectory = null, ProcessSettings processSettings = null)
        {
            var process = ProcessTasks.StartProcess(AzureGroupPath, arguments, workingDirectory, processSettings?.EnvironmentVariables, processSettings?.ExecutionTimeout, processSettings?.RedirectOutput ?? true);
