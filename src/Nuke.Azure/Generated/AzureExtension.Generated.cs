...
namespace Nuke.Azure
{
    ...
    public static partial class AzureExtensionTasks
    {
        ...
        public static IEnumerable<string> AzureExtension(string arguments, string workingDirectory = null, ProcessSettings processSettings = null)
        {
            var process = ProcessTasks.StartProcess(AzureExtensionPath, arguments, workingDirectory, processSettings?.EnvironmentVariables, processSettings?.ExecutionTimeout, processSettings?.RedirectOutput ?? true);
