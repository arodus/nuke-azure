...
namespace Nuke.Azure
{
    ...
    public static partial class AzureRedisTasks
    {
        ...
        public static IEnumerable<string> AzureRedis(string arguments, string workingDirectory = null, ProcessSettings processSettings = null)
        {
            var process = ProcessTasks.StartProcess(AzureRedisPath, arguments, workingDirectory, processSettings?.EnvironmentVariables, processSettings?.ExecutionTimeout, processSettings?.RedirectOutput ?? true);
