...
namespace Nuke.Azure
{
    ...
    public static partial class AzureMapsTasks
    {
        ...
        public static IEnumerable<string> AzureMaps(string arguments, string workingDirectory = null, ProcessSettings processSettings = null)
        {
            var process = ProcessTasks.StartProcess(AzureMapsPath, arguments, workingDirectory, processSettings?.EnvironmentVariables, processSettings?.ExecutionTimeout, processSettings?.RedirectOutput ?? true);
