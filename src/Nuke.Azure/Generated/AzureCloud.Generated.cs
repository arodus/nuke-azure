...
namespace Nuke.Azure
{
    ...
    public static partial class AzureCloudTasks
    {
        ...
        public static IEnumerable<string> AzureCloud(string arguments, string workingDirectory = null, ProcessSettings processSettings = null)
        {
            var process = ProcessTasks.StartProcess(AzureCloudPath, arguments, workingDirectory, processSettings?.EnvironmentVariables, processSettings?.ExecutionTimeout, processSettings?.RedirectOutput ?? true);
        ...
        /// <summary><p>Manage registered Azure clouds.</p><p>For more details, visit the <a href="https://raw.githubusercontent.com/Azure/azure-docs-cli-python/live/latest/docs-ref-autogen/cloud.yml">official website</a>.</p></summary>
