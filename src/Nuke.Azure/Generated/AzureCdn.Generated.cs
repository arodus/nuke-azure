...
namespace Nuke.Azure
{
    ...
    public static partial class AzureCdnTasks
    {
        ...
        public static IEnumerable<string> AzureCdn(string arguments, string workingDirectory = null, ProcessSettings processSettings = null)
        {
            var process = ProcessTasks.StartProcess(AzureCdnPath, arguments, workingDirectory, processSettings?.EnvironmentVariables, processSettings?.ExecutionTimeout, processSettings?.RedirectOutput ?? true);
