...
namespace Nuke.Azure
{
    ...
    public static partial class AzureCognitiveservicesTasks
    {
        ...
        public static IEnumerable<string> AzureCognitiveservices(string arguments, string workingDirectory = null, ProcessSettings processSettings = null)
        {
            var process = ProcessTasks.StartProcess(AzureCognitiveservicesPath, arguments, workingDirectory, processSettings?.EnvironmentVariables, processSettings?.ExecutionTimeout, processSettings?.RedirectOutput ?? true);
