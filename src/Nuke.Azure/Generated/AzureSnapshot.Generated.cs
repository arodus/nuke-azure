...
namespace Nuke.Azure
{
    ...
    public static partial class AzureSnapshotTasks
    {
        ...
        public static IEnumerable<string> AzureSnapshot(string arguments, string workingDirectory = null, ProcessSettings processSettings = null)
        {
            var process = ProcessTasks.StartProcess(AzureSnapshotPath, arguments, workingDirectory, processSettings?.EnvironmentVariables, processSettings?.ExecutionTimeout, processSettings?.RedirectOutput ?? true);
