...
namespace Nuke.Azure
{
    ...
    public static partial class AzureAdvisorTasks
    {
        ...
        public static IEnumerable<string> AzureAdvisor(string arguments, string workingDirectory = null, ProcessSettings processSettings = null)
        {
            var process = ProcessTasks.StartProcess(AzureAdvisorPath, arguments, workingDirectory, processSettings?.EnvironmentVariables, processSettings?.ExecutionTimeout, processSettings?.RedirectOutput ?? true);
