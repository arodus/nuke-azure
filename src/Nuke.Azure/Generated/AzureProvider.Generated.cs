...
namespace Nuke.Azure
{
    ...
    public static partial class AzureProviderTasks
    {
        ...
        public static IEnumerable<string> AzureProvider(string arguments, string workingDirectory = null, ProcessSettings processSettings = null)
        {
            var process = ProcessTasks.StartProcess(AzureProviderPath, arguments, workingDirectory, processSettings?.EnvironmentVariables, processSettings?.ExecutionTimeout, processSettings?.RedirectOutput ?? true);
