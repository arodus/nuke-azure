...
namespace Nuke.Azure
{
    ...
    public static partial class AzureReservationsTasks
    {
        ...
        public static IEnumerable<string> AzureReservations(string arguments, string workingDirectory = null, ProcessSettings processSettings = null)
        {
            var process = ProcessTasks.StartProcess(AzureReservationsPath, arguments, workingDirectory, processSettings?.EnvironmentVariables, processSettings?.ExecutionTimeout, processSettings?.RedirectOutput ?? true);
