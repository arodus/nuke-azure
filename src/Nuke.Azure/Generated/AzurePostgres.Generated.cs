...
namespace Nuke.Azure
{
    ...
    public static partial class AzurePostgresTasks
    {
        ...
        public static IEnumerable<string> AzurePostgres(string arguments, string workingDirectory = null, ProcessSettings processSettings = null)
        {
            var process = ProcessTasks.StartProcess(AzurePostgresPath, arguments, workingDirectory, processSettings?.EnvironmentVariables, processSettings?.ExecutionTimeout, processSettings?.RedirectOutput ?? true);
