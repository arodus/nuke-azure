...
namespace Nuke.Azure
{
    ...
    public static partial class AzureConsumptionTasks
    {
        ...
        public static IEnumerable<string> AzureConsumption(string arguments, string workingDirectory = null, ProcessSettings processSettings = null)
        {
            var process = ProcessTasks.StartProcess(AzureConsumptionPath, arguments, workingDirectory, processSettings?.EnvironmentVariables, processSettings?.ExecutionTimeout, processSettings?.RedirectOutput ?? true);
