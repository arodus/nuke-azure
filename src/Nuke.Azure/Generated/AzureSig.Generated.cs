...
namespace Nuke.Azure
{
    ...
    public partial class AzureSigUpdateSettings : ToolSettings
    {
        /// <summary><p>Path to the AzureSig executable.</p></summary>
        public override string ToolPath => base.ToolPath ?? AzureSigTasks.AzureSigPath;
        /// <summary><p>Parameters supplied to the create or update gallery operation.</p></summary>
        public virtual string Gallery { get; internal set; }
        /// <summary><p>Gallery name.</p></summary>
        public virtual string GalleryName { get; internal set; }
        /// <summary><p>Name of resource group. You can configure the default group using `az configure --defaults group=&amp;lt;name&amp;gt;`.</p></summary>
        public virtual string ResourceGroup { get; internal set; }
    ...
    public partial class AzureSigImageDefinitionUpdateSettings : ToolSettings
    {
        /// <summary><p>Path to the AzureSig executable.</p></summary>
        public override string ToolPath => base.ToolPath ?? AzureSigTasks.AzureSigPath;
        /// <summary><p>Parameters supplied to the create or update gallery image operation.</p></summary>
        public virtual string GalleryImage { get; internal set; }
        /// <summary><p>Gallery image definition.</p></summary>
        public virtual string GalleryImageDefinition { get; internal set; }
        /// <summary><p>Gallery name.</p></summary>
        public virtual string GalleryName { get; internal set; }
    ...
    {
        #region Gallery
        /// <summary><p><em>Sets <see cref="AzureSigUpdateSettings.Gallery"/>.</em></p><p>Parameters supplied to the create or update gallery operation.</p></summary>
        [Pure]
        public static AzureSigUpdateSettings SetGallery(this AzureSigUpdateSettings toolSettings, string gallery)
        {
            toolSettings = toolSettings.NewInstance();
            toolSettings.Gallery = gallery;
            return toolSettings;
        }
        /// <summary><p><em>Resets <see cref="AzureSigUpdateSettings.Gallery"/>.</em></p><p>Parameters supplied to the create or update gallery operation.</p></summary>
        [Pure]
        public static AzureSigUpdateSettings ResetGallery(this AzureSigUpdateSettings toolSettings)
        {
            toolSettings = toolSettings.NewInstance();
            toolSettings.Gallery = null;
            return toolSettings;
        }
        #endregion
        #region GalleryName
    ...
    {
        #region GalleryImage
        /// <summary><p><em>Sets <see cref="AzureSigImageDefinitionUpdateSettings.GalleryImage"/>.</em></p><p>Parameters supplied to the create or update gallery image operation.</p></summary>
        [Pure]
        public static AzureSigImageDefinitionUpdateSettings SetGalleryImage(this AzureSigImageDefinitionUpdateSettings toolSettings, string galleryImage)
        {
            toolSettings = toolSettings.NewInstance();
            toolSettings.GalleryImage = galleryImage;
            return toolSettings;
        }
        /// <summary><p><em>Resets <see cref="AzureSigImageDefinitionUpdateSettings.GalleryImage"/>.</em></p><p>Parameters supplied to the create or update gallery image operation.</p></summary>
        [Pure]
        public static AzureSigImageDefinitionUpdateSettings ResetGalleryImage(this AzureSigImageDefinitionUpdateSettings toolSettings)
        {
            toolSettings = toolSettings.NewInstance();
            toolSettings.GalleryImage = null;
            return toolSettings;
        }
        #endregion
        #region GalleryImageDefinition
