...
namespace Nuke.Azure
{
    ...
    public static partial class AzureRoleTasks
    {
        ...
        public static IEnumerable<string> AzureRole(string arguments, string workingDirectory = null, ProcessSettings processSettings = null)
        {
            var process = ProcessTasks.StartProcess(AzureRolePath, arguments, workingDirectory, processSettings?.EnvironmentVariables, processSettings?.ExecutionTimeout, processSettings?.RedirectOutput ?? true);
