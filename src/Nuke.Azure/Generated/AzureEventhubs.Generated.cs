...
namespace Nuke.Azure
{
    ...
    public static partial class AzureEventhubsTasks
    {
        ...
        public static IEnumerable<string> AzureEventhubs(string arguments, string workingDirectory = null, ProcessSettings processSettings = null)
        {
            var process = ProcessTasks.StartProcess(AzureEventhubsPath, arguments, workingDirectory, processSettings?.EnvironmentVariables, processSettings?.ExecutionTimeout, processSettings?.RedirectOutput ?? true);
