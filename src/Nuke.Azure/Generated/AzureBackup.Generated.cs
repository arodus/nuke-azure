...
namespace Nuke.Azure
{
    ...
    public static partial class AzureBackupTasks
    {
        ...
        public static IEnumerable<string> AzureBackup(string arguments, string workingDirectory = null, ProcessSettings processSettings = null)
        {
            var process = ProcessTasks.StartProcess(AzureBackupPath, arguments, workingDirectory, processSettings?.EnvironmentVariables, processSettings?.ExecutionTimeout, processSettings?.RedirectOutput ?? true);
