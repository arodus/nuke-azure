...
namespace Nuke.Azure
{
    ...
    public static partial class AzureFeatureTasks
    {
        ...
        public static IEnumerable<string> AzureFeature(string arguments, string workingDirectory = null, ProcessSettings processSettings = null)
        {
            var process = ProcessTasks.StartProcess(AzureFeaturePath, arguments, workingDirectory, processSettings?.EnvironmentVariables, processSettings?.ExecutionTimeout, processSettings?.RedirectOutput ?? true);
