...
namespace Nuke.Azure
{
    ...
    public static partial class AzureManagedappTasks
    {
        ...
        public static IEnumerable<string> AzureManagedapp(string arguments, string workingDirectory = null, ProcessSettings processSettings = null)
        {
            var process = ProcessTasks.StartProcess(AzureManagedappPath, arguments, workingDirectory, processSettings?.EnvironmentVariables, processSettings?.ExecutionTimeout, processSettings?.RedirectOutput ?? true);
