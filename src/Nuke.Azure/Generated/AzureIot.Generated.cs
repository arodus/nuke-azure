...
namespace Nuke.Azure
{
    ...
    public static partial class AzureIotTasks
    {
        ...
        public static IEnumerable<string> AzureIot(string arguments, string workingDirectory = null, ProcessSettings processSettings = null)
        {
            var process = ProcessTasks.StartProcess(AzureIotPath, arguments, workingDirectory, processSettings?.EnvironmentVariables, processSettings?.ExecutionTimeout, processSettings?.RedirectOutput ?? true);
