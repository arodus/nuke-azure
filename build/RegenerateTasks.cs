...
internal static class RegenerateTasks
{
    public struct ReleaseInformation
    {
        ...
        public ReleaseInformation(Version version, GitVersionBump bump)
        {
            Version = version;
            Bump = bump;
        }
    ...
    public static ReleaseInformation GetReleaseInformation(IReadOnlyList<Release> releases, Func<Release, Version> parseVersion)
    {
